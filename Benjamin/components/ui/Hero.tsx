...
const Hero = () => {
    return ( 
    <div className="flex flex-col lg:flex-row items-center justify-around lg:p-5 text-gray-100 bg-gradient-to-r from-Green to-Yellow h-full mb-20">
        <div className="flex flex-col items-center lg:items-start justify-center gap-10 p-4 lg:p-0 lg:w-2/4">
            ...
            <Button size={"lg"} className="rounded-full w-52 mb-10 lg:mb-0 h-16 text-xl text-gray-200 font-bold lg:w-60 max-w-60 bg-DarkGray border-black hover:shadow-black">
                Start shopping
            </Button>
        </div>
        <div>
