        ...
        <Card className="min-w-[250px] max-w-[350px] border border-black bg-gray-700 ">
          <CardHeader>
              <div className="flex gap-2 items-center justify-center">
                  {card.logo}
            <CardTitle className="text-xl md:text-2xl ml-4 font-bold font-handlee text-Yellow" >{card.title}</CardTitle>

              </div>
            <CardDescription className="text-xl text-gray-200">{card.decription}</CardDescription>
          </CardHeader>
        </Card>
      ))}
    </div>
