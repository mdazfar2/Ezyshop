  ...
  return (
    <>
      ...
      <div className="flex h-screen w-full items-center justify-center">
        <div className="flex rounded-lg justify-between relative lg:h-4/6 lg:w-2/4 border overflow-hidden">
          {/* First background div */}
          <div
            className={`w-full h-full absolute left-60 bottom-[9.5rem] rotate-45 transition-opacity duration-1000 ease-in-out bg-customTeal ${
              switchCss ? "opacity-100" : "opacity-0"
            }`}
          ></div>
          {/* Second background div */}
          <div
            className={`w-full h-full absolute right-60 bottom-[9.5rem] -rotate-45 transition-opacity duration-1000 ease-in-out bg-customTeal ${
              !switchCss ? "opacity-100" : "opacity-0"
            }`}
          ></div>
          ...
          {switchCss && !isResetOpen && (
            <div className="flex flex-col z-10 items-center justify-start pt-24  pr-14 gap-4 w-2/4">
              <div className="font-nunito text-4xl font-extrabold">Login</div>
              <div className="flex items-center w-4/5 justify-center">
                ...
                />
                <User className="h-7 w-7 text-customTeal" />
              </div>
              <div className="flex items-center w-4/5 justify-center">
                <Input
                  className="rounded-full"
                ...
                />
                <Lock className="h-7 w-7 text-customTeal" />
              </div>
              <Button className="rounded-full font-bold h-10 w-4/5 bg-customTeal">
                Login
              </Button>
              <div
                className="text-customTeal cursor-pointer"
          ...
          {!switchCss && (
            <div className="flex flex-col z-10 items-center justify-start pt-24  pl-14 gap-4 w-2/4">
              <div className="font-nunito text-4xl font-extrabold">Sign Up</div>
              <div className="flex items-center w-4/5 justify-center">
                <Input
                  className="rounded-full"
                  type="text"
              ...
              <Button className="rounded-full h-10 w-4/5 font-bold bg-customTeal">
                Sign Up
              </Button>
              <div className="flex items-center justify-center gap-2">
