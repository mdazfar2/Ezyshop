...
const products = [
    ...
    // Books
    { product_title: "The Great Gatsby", product_category: "Books", product_shop: "Books & Beyond", product_img_url: "", product_id: 56, cost: 10 },
    { product_title: "1984", product_category: "Books", product_shop: "Readers Paradise", product_img_url: "", product_id: 57, cost: 12 },
    { product_title: "To Kill a Mockingbird", product_category: "Books", product_shop: "Books & Beyond", product_img_url: "", product_id: 58, cost: 15 },
    { product_title: "Pride and Prejudice", product_category: "Books", product_shop: "Readers Paradise", product_img_url: "", product_id: 59, cost: 10 },
    { product_title: "Moby Dick", product_category: "Books", product_shop: "Books & Beyond", product_img_url: "", product_id: 60, cost: 18 },
    
    // Toys
    { product_title: "Building Blocks", product_category: "Toys", product_shop: "Toy Kingdom", product_img_url: "", product_id: 63, cost: 30 },
    { product_title: "Puzzle Game", product_category: "Toys", product_shop: "Funland", product_img_url: "", product_id: 64, cost: 25 },
    { product_title: "Action Figure", product_category: "Toys", product_shop: "Toy Kingdom", product_img_url: "", product_id: 65, cost: 20 },
    { product_title: "Doll Set", product_category: "Toys", product_shop: "Funland", product_img_url: "", product_id: 66, cost: 35 },
    { product_title: "Remote Control Car", product_category: "Toys", product_shop: "Toy Kingdom", product_img_url: "", product_id: 67, cost: 45 },
    
    // Baby Products
    { product_title: "Diapers (Pack of 30)", product_category: "Baby Products", product_shop: "Baby World", product_img_url: "", product_id: 68, cost: 25 },
    { product_title: "Baby Wipes", product_category: "Baby Products", product_shop: "Tiny Tots", product_img_url: "", product_id: 69, cost: 10 },
    { product_title: "Baby Monitor", product_category: "Baby Products", product_shop: "Baby World", product_img_url: "", product_id: 70, cost: 70 },
    { product_title: "Baby Stroller", product_category: "Baby Products", product_shop: "Tiny Tots", product_img_url: "", product_id: 71, cost: 120 },
    
    // Automotive
    { product_title: "Car Wax", product_category: "Automotive", product_shop: "AutoPro", product_img_url: "", product_id: 75, cost: 15 },
    { product_title: "Tire Inflator", product_category: "Automotive", product_shop: "Car Care", product_img_url: "", product_id: 80, cost: 30 },
    ...
    { product_title: "Cat Litter", product_category: "Pet Supplies", product_shop: "Furry Friends", product_img_url: "", product_id: 82, cost: 20 },
...
//     let headerName = "all";
//     let pathGeneralHeading = (shop)?"Our Shops":"Our Categories";
//     if(shop){
...
//         headerName = category;
//     }
//     const pathHeadingElement = document.getElementById('path-heading');
//     pathHeadingElement.textContent = headerName;
//     const pathGeneralElement = document.getElementById('path-general');
//     pathGeneralElement.textContent = pathGeneralHeading;
//     const pathSpecificElement = document.getElementById('path-specific');
//     pathSpecificElement.textContent = headerName;
