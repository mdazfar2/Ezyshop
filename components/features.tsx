...
return (
  ...
  <div className="flex items-center  justify-center py-10 px-4 h-full">
    ...
    <div className="h-full flex flex-col gap-4 md:grid md:grid-cols-2 lg:gap-10 lg:grid-cols-3 ">
      {cardData.map((card) => (
        <Card key={card.title} className="hover:cursor-pointer hover:shadow-2xl hover:scale-105 duration-150 min-w-[250px] max-w-[350px] border border-black bg-gray-200 dark:bg-gray-700 ">
          <CardHeader>
