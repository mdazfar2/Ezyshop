...
const Chatbot = () => {
  ...
  const flow= [
    ...
    },
    {
      id: "5",
      options: [
        { value: "Request a product from a vendor", label: "Request a product", trigger: "6" },
        { value: "Browse product categories", label: "Browse categories", trigger: "8" },
    ...
    {
      id: "9",
      message: "Awesome! We will connect you to a vendor specializing in {previousValue} products. Please wait a moment.",
      trigger: "10",
    },
    {
      id: "10",
    ...
    },
    {
      ...
      options: [
        ...
        { value: "HomeComfort", label: "HomeComfort (Furniture)", trigger: "18" },
      ],
    },
    {
      id: "18",
