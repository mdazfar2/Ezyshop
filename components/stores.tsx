  ...
  return (
    <div className="flex flex-col items-center justify-center gap-5 pb-10 h-full">
      ...
      <div className="h-full flex flex-col gap-5 px-5 md:grid md:grid-cols-2 lg:grid-cols-3 lg:gap-20">
        {cardData.map((card) => (
          <Card  key={card.title} className="sm:w-[400px] md:hover:scale-105 border border-DarkGray transition duration-300 bg-gray-200 dark:bg-gray-700">
            <CardHeader className="border-b border-gray-400 dark:border-DarkGray">
              <div className="flex flex-col gap-2">
               <div className="relative">
               <Image width={1000} height={1000} className="z-0" alt="card image" src={card.logo} />
            ...
            <CardContent>
              <div className="flex dark:text-gray-200 items-center justify-center font-nunito">
                <div className="border-r border-gray-400 dark:border-DarkGray font-semibold">
                  <div className="border-b border-gray-400 dark:border-DarkGray p-2">Category</div>
                  <div className="border-b border-gray-400 dark:border-DarkGray p-2">Offers Available</div>
                  <div className="border-b border-gray-400 dark:border-DarkGray p-2">Delivery Time</div>
                  <div className="border-b border-gray-400 dark:border-DarkGray p-2">Starting from</div>
                </div>
                <div>
                  <div className="border-b border-gray-400 dark:border-DarkGray p-2">{card.category}</div>
                  <div className="border-b border-gray-400 dark:border-DarkGray p-2">{card.Offers}</div>
                  <div className="border-b border-gray-400 dark:border-DarkGray p-2">{card.deliveryTime}</div>
                  <div className="border-b border-gray-400 dark:border-DarkGray p-2">{card.StartingFrom}</div>
                </div>
              </div>
            </CardContent>
            <CardFooter className="flex justify-center">
              <Button variant="default" className="bg-customTeal dark:bg-Green text-gray-200 rounded-full">
                Shop Now
              </Button>
            </CardFooter>
          </Card>
