      ...
      <div className="pl-5 flex flex-col items-center gap-5 text-start pt-5">
        ...
        <div className="p-4 bg-gray-100 dark:bg-gray-700 font-nunito dark:text-gray-200 text-xl w-3/4  rounded-lg shadow-md space-y-4">
          <div className="flex justify-between">
            <span className="font-semibold text-customTeal dark:text-Green">Shop Name:</span>
            <span>{seller.storeName}</span>
          </div>

          <div className="flex justify-between">
            <span className="font-semibold text-customTeal dark:text-Green">Owner Name:</span>
            <span>{seller.name || "N/A"}</span>
          </div>

          <div className="flex justify-between">
            <span className="font-semibold text-customTeal dark:text-Green">Address:</span>
            <span>{seller.storeAddress}</span>
          </div>

          <div className="flex justify-between">
            <span className="font-semibold text-customTeal dark:text-Green">UPI:</span>
            <span>{seller.storeUPI}</span>
          </div>

          <div className="flex justify-between">
            <span className="font-semibold text-customTeal dark:text-Green">Mobile:</span>
            <span>{seller.storeMobile}</span>
          </div>

          <div className="flex justify-between">
            <span className="font-semibold text-customTeal dark:text-Green">Email:</span>
            <span>{seller.email || "N/A"}</span>
          </div>

          <div className="flex justify-between">
            <span className="font-semibold text-customTeal dark:text-Green">Description:</span>
            <span>{seller.storeDescription}</span>
          </div>

          {seller.coverUrl && (
            <div className="flex items-center justify-between">
              <div className="font-semibold text-customTeal dark:text-Green mb-2">Cover Image:</div>
              <Image
                height={1000}
                width={1000}
                src={seller.coverUrl}
