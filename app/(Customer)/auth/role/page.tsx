...
const Login = () => {
  return (
    <div className="dark:bg-DarkGray ">
      <div className="flex h-screen w-full items-center min-h-96 justify-center">
        <div className="flex rounded-2xl p-10 lg:p-0 justify-between shadow-xl shadow-black dark:shadow-Green relative lg:h-4/6 lg:w-2/4 border overflow-hidden">
          ...
          ></div>
          <DropdownMenu>
            <DropdownMenuTrigger className="flex bg-customTeal dark:bg-Green rounded-full p-5 ml-20 mt-10 md:mt-20 lg:mt-40 h-10 items-center justify-center">
              Proceed as a
