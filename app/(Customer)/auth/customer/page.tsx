...
const Login = () => {
  ...
  return (
    <div className="dark:bg-DarkGray ">
      ...
      <div className="flex lg:h-screen h-full w-full flex-col lg:flex-row items-center justify-center">
        <div
          className={`text-white lg:hidden flex mt-10 px-4 flex-col max-h-60 w-full z-10 `}
        >
        ...
        <div className="flex rounded-2xl my-10 lg:my-0 justify-between shadow-xl shadow-black dark:shadow-Green relative lg:h-4/6 lg:w-2/4 border overflow-hidden">
