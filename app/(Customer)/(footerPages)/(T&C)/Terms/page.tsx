  ...
  return (
    ...
    <div className="dark:bg-DarkGray">
      ...
      <div className="max-w-4xl mx-auto p-8">
        <h2 className="text-2xl font-bold mb-2 dark:text-yellow-500">1. General Terms</h2>
        ...
        <h2 className="text-2xl font-bold mb-2 dark:text-yellow-500">2. Acceptance of Terms</h2>
        <p className="mb-4 dark:text-gray-400">
        ...
        <h2 className="text-2xl font-bold mb-2 dark:text-yellow-500">3. User Responsibilities</h2>
        <p className="mb-4 dark:text-gray-400">
        ...
        <h2 className="text-2xl font-bold mb-2 dark:text-yellow-500">4. Account Responsibilities</h2>
        <p className="mb-4 dark:text-gray-400">
        ...
        <h2 className="text-2xl font-bold mb-2 dark:text-yellow-500">5. Order Placement</h2>
        <p className="mb-4 dark:text-gray-400">
        ...
        <h2 className="text-2xl font-bold mb-2 dark:text-yellow-500">6. Payment Terms</h2>
        <p className="mb-4 dark:text-gray-400">
        ...
        <h2 className="text-2xl font-bold mb-2 dark:text-yellow-500">7. Return and Refund Policy</h2>
        <p className="mb-4 dark:text-gray-400">
        ...
        <h2 className="text-2xl font-bold mb-2 dark:text-yellow-500">8. Intellectual Property</h2>
        <p className="mb-4 dark:text-gray-400">
        ...
        <h2 className="text-2xl font-bold mb-2 dark:text-yellow-500">9. Contact Us</h2>
        <p className="mb-4 dark:text-gray-400">
